...
class DadosDoPedido extends Component {
    ...
    renderDadosDoCarrinho(){
        ...
        carrinho.forEach((item) => {
            dados.push({
                "Serviço": item.produto.titulo + ' - ' + item.variacao.nome,
        ...
        return (
            <div className="flex-5">
                ...
                <br />
                <TabelaSimples
                    cabecalho={[ "Serviço", "Preço Und.", "Quantidade", "Preço Total" ]}
                    dados={dados} />
            </div>
        )
    }
    ...
    renderDadosDeEntrega(){
        ...
        return (
            <div className="flex-3">
                <h4 className="headline">DADOS DO LOCAL DA REALIZAÇÃO</h4>
                <br />
        ...
        return (
            <div className="flex-5">
                ...
                <TextoDados chave="Forma de Pagamento" 
                    valor={`${pagamento.forma === "boleto" ? "Transferência Bancária" : "Cartão de Crédito"} `} />
            </div>
        )
    }
