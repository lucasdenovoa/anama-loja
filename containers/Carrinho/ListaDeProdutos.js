...
return alert("ja era");
  ...
  if(item.variacao.quantidade === 0) {
console.log(item.variacao.quantidade);
alert(item.variacao.quantidade);
localStorage.removeItem("@cart");
return alert("não temos essa quantidade em estoque, broooooo");
}
...
{/*mudei aqui*/}               <div className="flex-1 flex flex-center">
                    {
                        semAlteracoes ?
