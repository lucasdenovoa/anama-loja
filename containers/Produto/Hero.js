...
class Hero extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            qtd: 0,
            variacao: variacoes && variacoes.length >= 0 ? variacoes[0]._id : null,
            variacaoCompleta: variacoes && variacoes.length >= 0 ? variacoes[0] : null
        };
    }
...
if(qtd > produto.quantidade) alert('nao temos cara');      
  addCart({
            produto: produto._id,
            variacao,
            quantidade: qtd,
